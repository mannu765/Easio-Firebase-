...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> deletePatient(String patientId) async {
    ...
    try {
      ...
      showSnackBarText(patientDeleted);
    } catch (error) {
      showSnackBarText('$failedDelete $error');
    }
  }
  ...
  Widget _displayCard(PatientData patientDetails) {
    ...
    return GestureDetector(
        child: Card(
          color: whiteColor,
          margin: EdgeInsets.all(screenWidth! * 0.037),
          elevation: 5,
                  ...
                  children: [
                    Padding(
                      padding: EdgeInsets.fromLTRB(
                          screenWidth! * 0.024, 0, screenWidth! * 0.061, 0),
                      child: CircleAvatar(
                    ...
                    Padding(
                      padding:
                          EdgeInsets.fromLTRB(0, 0, screenWidth! * 0.024, 0),
                      child: IconButton(
                          onPressed: () {
                            showDialog<String>(
                              context: context,
        ...
        onTap: () async {
          ...
          await Navigator.of(context)
            ...
            if (result.isNotEmpty) {
              functionCall = filterPatients(result, daysList,
                  filterSelectedFromDate1, filterSelectedToDate1);
  ...
  todayAppointments() {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Padding(
          padding: EdgeInsets.fromLTRB(screenWidth! * 0.073, 0, 0, 0),
          child: const Center(
            child: Text(
              todaysAppointments,
            ),
  ...
  patientDetails() {
    return Stack(
      children: [
              ...
              child: Row(
                children: [
                  Expanded(
                    child: Padding(
                      padding: EdgeInsets.fromLTRB(
                          screenWidth! * 0.034, screenHeight! * 0.015, 0, 0),
                      child: Container(
                        decoration: BoxDecoration(
                          color: whiteColor,
                          borderRadius: BorderRadius.circular(10),
                  ...
                  Padding(
                    padding: EdgeInsets.fromLTRB(screenWidth! * 0.0098,
                        screenHeight! * 0.015, screenWidth! * 0.0099, 0),
                    child: Badge(
        ...
        Padding(
          padding: EdgeInsets.fromLTRB(
              0, 0, screenWidth! * 0.024, screenHeight! * 0.015),
          child: Align(
